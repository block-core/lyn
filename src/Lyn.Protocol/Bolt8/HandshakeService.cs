...
namespace Lyn.Protocol.Bolt8
{
    public class HandshakeService : IHandshakeService
    {
        ...
        public void InitiateHandShake(byte[] privateKey)
        {
            ...
            _logger.LogDebug("{0} Initiating handshake hash", _sessionId);
        ...
        {
            _logger.LogDebug("{0} Responder handshake: started act three", _sessionId);
            ...
            _logger.LogDebug("{0} Completed act three with remote {1}", _sessionId,
