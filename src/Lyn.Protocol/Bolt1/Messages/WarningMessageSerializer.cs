...
{
    public class WarningMessageSerializer: IProtocolTypeSerializer<WarningMessage>
    {
        public int Serialize(WarningMessage typeInstance, IBufferWriter<byte> writer,
        ...
        public WarningMessage Deserialize(ref SequenceReader<byte> reader, ProtocolTypeSerializerOptions? options = null)
        {
