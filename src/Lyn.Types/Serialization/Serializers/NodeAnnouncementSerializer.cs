...
namespace Lyn.Types.Serialization.Serializers
{
    ...
    {
        public int Serialize(NodeAnnouncement typeInstance, int protocolVersion, IBufferWriter<byte> writer,
        ...
        public NodeAnnouncement Deserialize(ref SequenceReader<byte> reader, int protocolVersion,
            ProtocolTypeSerializerOptions? options = null)
        {
